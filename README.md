...
Нижче наведено скріншоти виконання програми в середовищі розробки:

<!-- Додайте сюди свої скріншоти, наприклад: -->
<!-- 
<img src="img/execution_screenshot1.png" width="80%" alt="Виконання програми в IDE"/>
<img src="img/execution_screenshot2.png" width="80%" alt="Результат виконання в консолі"/>
-->

> 💡 **Підказка**: Замініть коментарі вище на реальні зображення, зробивши скріншоти вашого середовища програмування під час виконання коду.
